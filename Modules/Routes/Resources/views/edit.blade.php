                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="name" type="text"
                                           ...
                                           value="{{ old('name',$route->name) }}" autocomplete="name" autofocus>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6 offset-md-4">
                                    <div class="form-check">
                                        ...
                                        <input class="form-check-input" type="checkbox" name="is_expressway" id="is_expressway" {{ old('is_expressway',$route->is_expressway) ? 'checked' : '' }} value="1">
